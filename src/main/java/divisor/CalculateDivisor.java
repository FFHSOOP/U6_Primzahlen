...
public class CalculateDivisor {
	...
	try {
	    futures = executorService.invokeAll(tasks); // Der executorService bekommt ein Tasks-Array, wird gestartet
	    						// und gibt ein Future-Array zur�ck
     ...
     * Die einzelnen Tasks werden in die task collection eingef�gt
     */
	...
	// F�gt die Ergebnisse der einzelnen DivisorResult-Objekte in den primzahlenString ein 
    ...
    /**
     * Es werden die einzelnen Tasks f�r die berechnung definiert
     * 
     * @author Stefan Nyffenegger
     * @author Benjamin Steffen
     * @author Marco Wyssmann
	 ...
	 * F�r jede Zahl im Intervall wird untersucht, ob sie eine Primzahl ist
	 * Die entsprechenden Primzahlen werden dem DivisorResult-Objekt hinzugef�gt
	 * 
	 * @return Gibt ein DivisorResult-Objekt mit den gefundenen Primzahlen zur�ck
	 */
        @Override
